...
exists a' => phi' coin Fphi' /FM_spec Fphi'Fphi'.
...
exists (gather_queries psi (size Qn) phi q') => phi' coin mf' /FqM_spec mf'val.
...
exists a' => psi' coin Fpsiphi /FM_spec val'.
have [Qn' com']:= val' q'.
