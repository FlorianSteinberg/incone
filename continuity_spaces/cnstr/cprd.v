...
Section isomorphisms.
  ...
  Proof.
    move => phi Fphi val.
    suff /choice: forall nq', exists L, certificate fun2sig_rlzr L phi nq' (Fphi nq') by trivial.
    move => [n q'].
  ...
  Proof.
    by exists zip_rlzr; split; try exact/zip_rlzr_spec; exact/cont_F2MF/zip_rlzr_cntop.
  Qed.
