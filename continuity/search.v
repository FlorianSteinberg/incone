(**
   This file defines the search function that takes a predicate (p: nat -> bool) and a bound n
   and returns the smallest natural number smaller than n that validates the predicate if such
   a number exists and the bound n itself otherwise.   
**)
